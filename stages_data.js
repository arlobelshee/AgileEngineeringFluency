	...
	return {
		...
		skills: {
			...
			SK_VISIBLE_WORK: {
				...
				obsoletes: [],
				description: [
					"bq>. If it is not on the board, it doesn't exist.",
					"",
					"h1. What this is",
					"",
					"There must be no hidden work, i.e. there must be no tasks or activities that team members do without others being aware of it.",
